<template>
    <div class="notdone-order rel section-2">
                        ...
                        <div class="right-part f-item rel">
                            <ul>
                                <li class="row-item list-inlineblock" v-for="item in orderList[curIndex].list" :key="item.no">
                                    ...
                                    <div class="body-item f-item w8"><div class="align"><button class="button round bg-main text-white button-size-small">删除</button></div></div>
                                </li>
                            </ul>
